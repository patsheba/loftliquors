...
function WOMSPluginBase(){
    ...
    var dialog_header = function(title){ return '<img style="width: 200px; height: 80px;" src="/assets/images/receipt-logo1.png"/><h3 class="smaller" style="margin-top: 5px;">'+title+'</h3>'; };
