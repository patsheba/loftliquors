                ...
                <table id="itemstable" class="table table-striped table-bordered table-hover dt-responsive"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="">WholeSale Price</th>
            ...
            <div class="tab-pane active in" id="itemdetails">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input id="itemwholesaleprice" type="text" value="0"/></td>
                    </tr>
                    <tr>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-stripped table-responsive"
                               style="margin-bottom: 0; padding-left: 10px; margin-right: 10px;">
                        ...
                        <button style="float: right; margin-right: 8px;" class="btn btn-primary btn-xs"
                                onclick="addItemModifier();">Add
                        </button>
                        ...
                        <button style="float: right; margin-right: 8px;" class="btn btn-primary btn-xs"
                                onclick="addSelectItemModifier();">Add
                        </button>
                    </div>
                </form>
            </div>
...
<div id="adddialog" class="hide">
    <table>
        ...
        <tr>
            <td style="text-align: right;"><label>Wholesale Price:&nbsp;</label></td>
            <td><input id="newitemwholesaleprice" type="text" value="0"/></td>
        </tr>
        <tr>
            <td style="text-align: right;"><label>Tax:&nbsp;</label></td>
...
<script type="text/javascript">
            ...
            "aoColumns": [
                ...
                {"mData": "qty"},
                {
                    "mData": function (data, type, val) {
                        return (data['price'] == "" ? "" : WPOS.util.currencyFormat(data["price"]));
                    }
                },
                {
                    "mData": function (data, type, val) {
                        return (data['wholesale_price'] == "" ? "" : WPOS.util.currencyFormat(data["wholesale_price"]));
                    }
                },
                {"mData": "code"},
                {
                ...
                {
                    "mData": function (data, type, val) {
                        return (suppliers.hasOwnProperty(data.supplierid) ? suppliers[data.supplierid].name : 'None');
                    }
                },
                {
                    mData: null,
    ...
    function openEditDialog(id) {
        ...
        $("#itemwholesaleprice").val(item.wholesale_price);
    ...
    function saveItem(isnewitem) {
        ...
        if (isnewitem) {
            ...
            item.wholesale_price = $("#newitemwholesaleprice").val();
            ...
            item.wholesale_price = $("#itemwholesaleprice").val();
    ...
    function exportItems() {
        ...
        var csv = WPOS.data2CSV(
            ['ID', 'Stock Code', 'Name', 'Description', 'Default Qty', 'Unit Cost', 'Unit Price', 'WholeSale Price', 'Tax Rule Name', 'Category Name', 'Supplier Name'],
            ['id', 'code', 'name', 'description', 'qty', 'cost', 'price', 'wholesale_price',
                {
                    key: 'taxid', func: function (value) {
                        var taxtable = WPOS.getTaxTable().rules;
                        return taxtable.hasOwnProperty(value) ? taxtable[value].name : 'Unknown';
                    }
                },
                {
                ...
                {
                    key: 'supplierid', func: function (value) {
                        return suppliers.hasOwnProperty(value) ? suppliers[value].name : 'Unknown';
                    }
                }
            ],
            data
    ...
    function openImportDialog() {
        ...
        importdialog = $("body").csvImport({
            jsonFields: {
                ...
                'wholesale_price': {title: 'WholeSale Price', required: false, value: 0.0},
